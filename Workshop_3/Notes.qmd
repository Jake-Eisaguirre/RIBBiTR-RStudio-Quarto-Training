...
-   3 different presentation options: reveal.js (HTML), PowerPoint (MS Office), Beamer (LaTeX/PDF)
...
-   Make slide scrollable, point out cell options, out-height

##### Slide 9

-   code folding, point out cell options, fig-cap
