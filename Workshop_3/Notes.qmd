...
-   Change color of title and "<hr>" with CSS styles hexcode. `color:#C1FFC1;`

-   Specify columns in slide, add bulleted list, add image, change width of columns

-   examine source and visual editor.

-    make tabset feature, Make bullet list incremental Insert images in tabset panel. Adjust location and size, flip between source or visual editor.
