...
-   Change color of title and horizontal rule with CSS styles hexcode.
    `color:#C1FFC1;`
...
-   make tabset feature, Make bullet list incremental Insert images in tabset panel.
    Adjust location and size, flip between source or visual editor.
    Code and words, code automtically inserting output
