...
<!--# Open manuscript.qmd, references.bib, length_weight.R -->
...
Similar workflow allows for development of any text document, including lecture notes, CV, etc., as well as presentations that will demonstrate in Workshop 3.
...
-   Create manuscript within an RStudio project (demonstrate).
    When working on that project, open using the project file (.Rproj).

-   Create subfolders for different types of files: code, data, docs, out.
...
-   manuscript.qmd: All sections typically included in a manuscript are present in rendered document (e.g., title, authors, affiliations, abstract, into, etc.).
...
-   Figures, Tables, & More:
    ...
    -   Tables: Can create tables directly from R objects.
